...
![形状继承图](https://zyb0408.github.io/gitbooks/onjava8/docs/images/1562204648023.png)
...
![乐器继承图](https://zyb0408.github.io/gitbooks/onjava8/docs/images/1562252767216.png)
...
![类图](https://zyb0408.github.io/gitbooks/onjava8/docs/images/1562406479787.png)
...
![img](https://zyb0408.github.io/gitbooks/onjava8/docs/images/1562409366638.png)
...
![img](https://zyb0408.github.io/gitbooks/onjava8/docs/images/1562409366637.png)

虽然这是一种有用且明智的方法（依赖具体情况），但是也存在缺点。派生类中接口的扩展部分在基类中不存在（不能通过基类访问到这些扩展接口），因此一旦向上转型，就不能通过基类调用这些新方法：

![img](https://zyb0408.github.io/gitbooks/onjava8/docs/images/1562409926765.png)
